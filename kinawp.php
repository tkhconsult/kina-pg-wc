...
function woocommerce_kinabank_embed_oembed_html( $html ) {
    return preg_replace('/<!-- kbliframeinnerdivstart([\s\S]*)\/kbliframeinnerdivend -->/', '<div id="kbliframeinnerdiv"><iframe id="kblpaymentiframe" name="kblpaymentiframe"></iframe></div>', $html);
}
...
function woocommerce_kinabank_init() {
	...
	class WC_KinaBank extends WC_Payment_Gateway {
		...
		protected function init_kb_client() {
			...
			$gatewayUrl = ($this->testmode ? 'https://devegateway.kinabank.com.pg/cgi-bin/cgi_link' : 'https://prodegateway.kinabank.com.pg/cgi-bin/cgi_link'); #ALT TEST kb19.kinabank.md
